...
class InstallData implements InstallDataInterface
{
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $data = [
            ...
            [3, 'Template 03 - Subscribe', '3', 'Magestore_Popupplus::popup/subscribe/template03.phtml\r\n', 'Magestore_Popupplus::popup/success/success03.phtml', '0', 'Magestore_Popupplus/images/popup/template_images/template03.png', 700, 'px', 'rounded', 10, '', 0, '000000', 'ffffff', 0, '', 0, 'top', NULL, 'center', 100, 'top', 100, NULL],
            [4, 'Template 04 - Subscribe', '4', 'Magestore_Popupplus::popup/subscribe/template04.phtml\r\n', 'Magestore_Popupplus::popup/success/success04.phtml', '0', 'Magestore_Popupplus/images/popup/template_images/template04.png', 500, 'px', 'rounded', 20, '', 0, '000000', 'BBAEAE', 20, 'circle', 0, 'bottom', NULL, 'center', 100, 'bottom', 100, NULL],
            [5, 'Template 05 - Subscribe', '5', 'Magestore_Popupplus::popup/subscribe/template05.phtml\r\n', 'Magestore_Popupplus::popup/success/success05.phtml', '0', 'Magestore_Popupplus/images/popup/template_images/template05.png', 420, 'px', 'circle', 0, '', 0, '000000', '6E6E6E', 20, 'circle', 0, 'top', NULL, 'center', 100, '', 100, NULL],
        ];
