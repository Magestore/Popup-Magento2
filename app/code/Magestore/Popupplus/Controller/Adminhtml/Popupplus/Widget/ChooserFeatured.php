...
class ChooserFeatured extends \Magestore\Popupplus\Controller\Adminhtml\Popupplus
{
    /**
    ...
    public function execute()
    {
        ...
        $block = $this->_view->getLayout()->createBlock(
            'Magestore\Popupplus\Block\Adminhtml\Popupplus\Widget\Chooser\FeaturedProducts',
