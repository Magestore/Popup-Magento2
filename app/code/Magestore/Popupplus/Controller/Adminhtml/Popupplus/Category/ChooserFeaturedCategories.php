...
class ChooserFeaturedCategories extends \Magestore\Popupplus\Controller\Adminhtml\Popupplus
{
    /**
    ...
    public function execute()
    {
        ...
        $block = $this->_view->getLayout()->createBlock(
            'Magestore\Popupplus\Block\Adminhtml\Popupplus\Category\Chooser\FeaturedCategories',
