 ...
 * Action ExportExcel
 */
class ExportExcel extends \Magestore\Popupplus\Controller\Adminhtml\Popupplus
{
    /**
     * Execute action
     */
    ...
    {
        $fileName = 'Popuppluss.xls';

        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->resultFactory->create(ResultFactory::TYPE_PAGE);
        $content = $resultPage->getLayout()->createBlock('Magestore\Popupplus\Block\Adminhtml\Popupplus\Grid')->getExcel();
